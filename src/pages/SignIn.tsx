      ...
      <div className="md:w-1/2 bg-[#C9974C] flex items-center justify-center p-6 relative overflow-hidden">
        ...
        <div className="w-full max-w-sm relative z-10">
          ...
          <div className="flex ml-2">
            <div className="bg-[#FFF8E7] border-2 border-b-0 border-[#1F2D3D] px-6 py-2 rounded-t-xl font-cabinet font-bold text-[#1F2D3D] z-10 text-sm shadow-[-2px_-2px_0px_rgba(0,0,0,0.05)]">
              Sign In
            </div>
            <Link 
              to="/signup" 
              className="bg-[#FFF8E7]/50 hover:bg-[#FFF8E7]/80 transition-all border-2 border-b-0 border-[#1F2D3D] border-l-0 px-6 py-2 rounded-t-xl font-cabinet font-bold text-[#1F2D3D]/60 text-sm"
            >
              Create Account
            </Link>
          </div>
          ...
          <div className="bg-[#FFF8E7] border-2 border-[#1F2D3D] shadow-[6px_6px_0px_0px_#1F2D3D] rounded-xl rounded-tl-none p-8 w-full">
            <h1 className="font-cabinet font-bold text-2xl text-[#1F2D3D] mb-6">Sign In</h1>
            ...
            <p className="text-sm text-[#6B7785] mt-5 text-center">
              ...
              <Link to="/signup" className="text-[#1F2D3D] font-medium hover:underline">
                Sign Up
              </Link>
            </p>
          </div>
